...
namespace Genesys.Authorization.Api
{
    ...
    public interface IAuthenticationApi : IApiAccessor
    {
        ...
        /// <param name="authorization">Basic authorization. Example: &#39;Authorization: Basic Y3...MQ&#x3D;&#x3D;&#39; (optional)</param>
        /// <param name="accept">Media types which are acceptable for the response. Example: &#39;Accept: *_/_*&#39; (optional)</param>
        ...
        DefaultOAuth2AccessToken RetrieveToken (string grantType, string scope, string authorization = null, string accept = null, string clientId = null, string username = null, string password = null);
        ...
        ApiResponse<DefaultOAuth2AccessToken> RetrieveTokenWithHttpInfo (string grantType, string scope, string authorization = null, string accept = null, string clientId = null, string username = null, string password = null);
        /// <summary>
        /// showlogout
        /// </summary>
        /// <remarks>
        ...
        ApiResponse<Object> ShowlogoutUsingGETWithHttpInfo ();
        /// <summary>
        /// Sign-out user
        /// </summary>
        /// <remarks>
        ...
        /// <returns>ApiResponse</returns>
        ApiResponse TenantInfo (AuthSchemeLookupOperation lookupOperation);
        ...
        /// <param name="lookupOperation">lookupOperation</param>
        /// <returns>ApiResponse of ApiResponse</returns>
        ApiResponse<ApiResponse> TenantInfoWithHttpInfo (AuthSchemeLookupOperation lookupOperation);
        ...
        System.Threading.Tasks.Task<DefaultOAuth2AccessToken> RetrieveTokenAsync (string grantType, string scope, string authorization = null, string accept = null, string clientId = null, string username = null, string password = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<DefaultOAuth2AccessToken>> RetrieveTokenAsyncWithHttpInfo (string grantType, string scope, string authorization = null, string accept = null, string clientId = null, string username = null, string password = null);
        /// <summary>
        /// showlogout
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<Object> ShowlogoutUsingGETAsync ();
        ...
        System.Threading.Tasks.Task<ApiResponse<Object>> ShowlogoutUsingGETAsyncWithHttpInfo ();
        /// <summary>
        /// Sign-out user
        /// </summary>
        /// <remarks>
        ...
        /// <param name="lookupOperation">lookupOperation</param>
        /// <returns>Task of ApiResponse</returns>
        System.Threading.Tasks.Task<ApiResponse> TenantInfoAsync (AuthSchemeLookupOperation lookupOperation);
        ...
        /// <param name="lookupOperation">lookupOperation</param>
        /// <returns>Task of ApiResponse (ApiResponse)</returns>
        System.Threading.Tasks.Task<ApiResponse<ApiResponse>> TenantInfoAsyncWithHttpInfo (AuthSchemeLookupOperation lookupOperation);
    ...
    public partial class AuthenticationApi : IAuthenticationApi
    {
        ...
        public ApiResponse<Object> AuthorizeWithHttpInfo (string responseType, string clientId, string redirectUri, string authorization = null)
        {
            ...
            var localVarPath = "/auth/v3/oauth/authorize";
        ...
        public ApiResponse< ApiResponse > ChangePasswordWithHttpInfo (ChangePasswordOperation request)
        {
            ...
            var localVarPath = "/auth/v3/change-password";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new Dictionary<String, String>();
            var localVarHeaderParams = new Dictionary<String, String>(Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
        ...
        /// <summary>
        /// Get user principal by OAUTH toke This endpoint is called by oAuth2 clients to retrieve the principal by oAuth access token
        /// </summary>
        /// <exception cref="Genesys.Authorization.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="authorization">OAuth 2.0 Bearer Token. Example: \&quot;Authorization: bearer a4b5da75-a584-4053-9227-0f0ab23ff06e\&quot; </param>
        /// <returns>CloudUserDetails</returns>
        ...
        public ApiResponse< CloudUserDetails > GetInfoWithHttpInfo (string authorization)
        {
            ...
            var localVarPath = "/auth/v3/userinfo";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new Dictionary<String, String>();
            var localVarHeaderParams = new Dictionary<String, String>(Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
        ...
        /// <param name="password">End-User password (optional)</param>
        /// <returns>DefaultOAuth2AccessToken</returns>
        public DefaultOAuth2AccessToken RetrieveToken (string grantType, string scope, string authorization = null, string accept = null, string clientId = null, string username = null, string password = null)
        {
             ApiResponse<DefaultOAuth2AccessToken> localVarResponse = RetrieveTokenWithHttpInfo(grantType, scope, authorization, accept, clientId, username, password);
             return localVarResponse.Data;
        }
        ...
        /// <param name="password">End-User password (optional)</param>
        /// <returns>ApiResponse of DefaultOAuth2AccessToken</returns>
        public ApiResponse< DefaultOAuth2AccessToken > RetrieveTokenWithHttpInfo (string grantType, string scope, string authorization = null, string accept = null, string clientId = null, string username = null, string password = null)
        {
            ...
            if (scope == null)
                throw new ApiException(400, "Missing required parameter 'scope' when calling AuthenticationApi->RetrieveToken");

            var localVarPath = "/auth/v3/oauth/token";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new Dictionary<String, String>();
            var localVarHeaderParams = new Dictionary<String, String>(Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
        ...
        /// <param name="password">End-User password (optional)</param>
        /// <returns>Task of DefaultOAuth2AccessToken</returns>
        public async System.Threading.Tasks.Task<DefaultOAuth2AccessToken> RetrieveTokenAsync (string grantType, string scope, string authorization = null, string accept = null, string clientId = null, string username = null, string password = null)
        {
             ApiResponse<DefaultOAuth2AccessToken> localVarResponse = await RetrieveTokenAsyncWithHttpInfo(grantType, scope, authorization, accept, clientId, username, password);
             return localVarResponse.Data;
        ...
        /// <param name="password">End-User password (optional)</param>
        /// <returns>Task of ApiResponse (DefaultOAuth2AccessToken)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<DefaultOAuth2AccessToken>> RetrieveTokenAsyncWithHttpInfo (string grantType, string scope, string authorization = null, string accept = null, string clientId = null, string username = null, string password = null)
        {
            // verify the required parameter 'grantType' is set
            if (grantType == null)
                throw new ApiException(400, "Missing required parameter 'grantType' when calling AuthenticationApi->RetrieveToken");
        ...
        /// <exception cref="Genesys.Authorization.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>Object</returns>
        public Object ShowlogoutUsingGET ()
        {
             ApiResponse<Object> localVarResponse = ShowlogoutUsingGETWithHttpInfo();
             return localVarResponse.Data;
        }
        ...
        /// <exception cref="Genesys.Authorization.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>ApiResponse of Object</returns>
        public ApiResponse< Object > ShowlogoutUsingGETWithHttpInfo ()
        {

            var localVarPath = "/auth/v3/signed-out";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new Dictionary<String, String>();
            var localVarHeaderParams = new Dictionary<String, String>(Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("ShowlogoutUsingGET", localVarResponse);
                if (exception != null) throw exception;
            }
        ...
        /// <exception cref="Genesys.Authorization.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>Task of Object</returns>
        public async System.Threading.Tasks.Task<Object> ShowlogoutUsingGETAsync ()
        {
             ApiResponse<Object> localVarResponse = await ShowlogoutUsingGETAsyncWithHttpInfo();
             return localVarResponse.Data;
        ...
        /// <exception cref="Genesys.Authorization.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>Task of ApiResponse (Object)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<Object>> ShowlogoutUsingGETAsyncWithHttpInfo ()
        {
        ...
        public ApiResponse< ApiResponse > SignOutWithHttpInfo (string authorization, bool? global = null)
        {
            ...
            var localVarPath = "/auth/v3/sign-out";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new Dictionary<String, String>();
            var localVarHeaderParams = new Dictionary<String, String>(Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
        ...
        /// <param name="lookupOperation">lookupOperation</param>
        /// <returns>ApiResponse</returns>
        public ApiResponse TenantInfo (AuthSchemeLookupOperation lookupOperation)
        {
             ApiResponse<ApiResponse> localVarResponse = TenantInfoWithHttpInfo(lookupOperation);
             return localVarResponse.Data;
        }
        ...
        /// <param name="lookupOperation">lookupOperation</param>
        /// <returns>ApiResponse of ApiResponse</returns>
        public ApiResponse< ApiResponse > TenantInfoWithHttpInfo (AuthSchemeLookupOperation lookupOperation)
        {
            // verify the required parameter 'lookupOperation' is set
            if (lookupOperation == null)
                throw new ApiException(400, "Missing required parameter 'lookupOperation' when calling AuthenticationApi->TenantInfo");

            var localVarPath = "/auth/v3/auth-scheme";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new Dictionary<String, String>();
            var localVarHeaderParams = new Dictionary<String, String>(Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
        ...
        /// <param name="lookupOperation">lookupOperation</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<ApiResponse> TenantInfoAsync (AuthSchemeLookupOperation lookupOperation)
        {
             ApiResponse<ApiResponse> localVarResponse = await TenantInfoAsyncWithHttpInfo(lookupOperation);
             return localVarResponse.Data;
        ...
        /// <param name="lookupOperation">lookupOperation</param>
        /// <returns>Task of ApiResponse (ApiResponse)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<ApiResponse>> TenantInfoAsyncWithHttpInfo (AuthSchemeLookupOperation lookupOperation)
        {
            // verify the required parameter 'lookupOperation' is set
            if (lookupOperation == null)
                throw new ApiException(400, "Missing required parameter 'lookupOperation' when calling AuthenticationApi->TenantInfo");
