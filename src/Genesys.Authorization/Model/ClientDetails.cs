...
namespace Genesys.Authorization.Model
{
    ...
    public partial class ClientDetails :  IEquatable<ClientDetails>, IValidatableObject
    {
        ...
        public ClientDetails(string ClientSecret = default(string), List<string> RegisteredRedirectUri = default(List<string>), bool? SecretRequired = default(bool?), string ClientId = default(string), List<string> ResourceIds = default(List<string>), int? AccessTokenValiditySeconds = default(int?), bool? Scoped = default(bool?), GrantedAuthority Authorities = default(GrantedAuthority), List<string> Scope = default(List<string>), List<string> AuthorizedGrantTypes = default(List<string>), int? RefreshTokenValiditySeconds = default(int?))
        {
