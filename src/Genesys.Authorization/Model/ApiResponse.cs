...
namespace Genesys.Authorization.Model
{
    ...
    public partial class ApiResponse :  IEquatable<ApiResponse>, IValidatableObject
    {
        ...
        public ApiResponse(ApiResponseStatus Status = default(ApiResponseStatus), string Path = default(string), ApiResponse Errors = default(ApiResponse), Object Data = default(Object))
        {
