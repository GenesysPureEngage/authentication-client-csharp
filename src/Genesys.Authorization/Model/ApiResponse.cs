...
namespace Genesys.Authorization.Model
{
    ...
    public partial class ApiResponse :  IEquatable<ApiResponse>, IValidatableObject
    {
        ...
        public ApiResponse(Object Data = default(Object), CollectionApiResponse Errors = default(CollectionApiResponse), string Path = default(string), ApiResponseStatus Status = default(ApiResponseStatus))
        {
        ...
        public CollectionApiResponse Errors { get; set; }
        /// <summary>
        /// Gets or Sets Path
        /// </summary>
