...
namespace Genesys.Authorization.Model
{
    ...
    public partial class DefaultOAuth2AccessToken :  IEquatable<DefaultOAuth2AccessToken>, IValidatableObject
    {
        ...
        public DefaultOAuth2AccessToken(string AccessToken = default(string), string IdToken = default(string), int? ExpiresIn = default(int?), string TokenType = default(string))
        {
