...
namespace Genesys.Authorization.Model
{
    ...
    public partial class CloudUserDetails :  IEquatable<CloudUserDetails>, IValidatableObject
    {
        ...
        public CloudUserDetails(string Username = default(string), string EnvironmentId = default(string), string LoginName = default(string), int? Dbid = default(int?), string ContactCenterId = default(string), string CmeUserName = default(string), UserRole Authorities = default(UserRole))
        {
