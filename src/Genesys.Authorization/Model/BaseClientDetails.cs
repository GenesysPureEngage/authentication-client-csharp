...
namespace Genesys.Authorization.Model
{
    ...
    public partial class BaseClientDetails :  IEquatable<BaseClientDetails>, IValidatableObject
    {
        ...
        public BaseClientDetails(int? AccessTokenValidity = default(int?), List<string> Authorities = default(List<string>), Collectionstring AuthorizedGrantTypes = default(Collectionstring), Collectionstring Autoapprove = default(Collectionstring), string ClientId = default(string), string ClientSecret = default(string), List<string> RedirectUri = default(List<string>), int? RefreshTokenValidity = default(int?), Collectionstring ResourceIds = default(Collectionstring), Collectionstring Scope = default(Collectionstring))
        {
        ...
        public Collectionstring AuthorizedGrantTypes { get; set; }
        /// <summary>
        /// Gets or Sets Autoapprove
        /// </summary>
        [DataMember(Name="autoapprove", EmitDefaultValue=false)]
        public Collectionstring Autoapprove { get; set; }
        /// <summary>
        ...
        public Collectionstring ResourceIds { get; set; }
        /// <summary>
        /// Gets or Sets Scope
        /// </summary>
        [DataMember(Name="scope", EmitDefaultValue=false)]
        public Collectionstring Scope { get; set; }
        /// <summary>
