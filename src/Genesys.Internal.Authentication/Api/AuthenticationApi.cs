...
namespace Genesys.Internal.Authentication.Api
{
    ...
    public interface IAuthenticationApi : IApiAccessor
    {
        ...
        CloudUserDetails ConvertToken (string authorization);
        ...
        ApiResponse<CloudUserDetails> ConvertTokenWithHttpInfo (string authorization);
        /// <summary>
        ...
        System.Threading.Tasks.Task<CloudUserDetails> ConvertTokenAsync (string authorization);
        ...
        System.Threading.Tasks.Task<ApiResponse<CloudUserDetails>> ConvertTokenAsyncWithHttpInfo (string authorization);
        /// <summary>
        /// Get user information by access token.
        /// </summary>
        /// <remarks>
    ...
    public partial class AuthenticationApi : IAuthenticationApi
    {
        ...
        /// <summary>
        /// Convert token. Convert OAuth 2 access token to JWT token accepted by Extension Code Grant
        /// </summary>
        /// <exception cref="Genesys.Internal.Authentication.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="authorization">The OAuth 2 bearer access token you received from &#x60;/auth/v3/oauth/token&#x60;. For example: \&quot;Authorization: bearer a4b5da75-a584-4053-9227-0f0ab23ff06e\&quot; </param>
        /// <returns>CloudUserDetails</returns>
        public CloudUserDetails ConvertToken (string authorization)
        {
             ApiResponse<CloudUserDetails> localVarResponse = ConvertTokenWithHttpInfo(authorization);
             return localVarResponse.Data;
        }
        ...
        /// <param name="authorization">The OAuth 2 bearer access token you received from &#x60;/auth/v3/oauth/token&#x60;. For example: \&quot;Authorization: bearer a4b5da75-a584-4053-9227-0f0ab23ff06e\&quot; </param>
        /// <returns>ApiResponse of CloudUserDetails</returns>
        public ApiResponse< CloudUserDetails > ConvertTokenWithHttpInfo (string authorization)
        {
            // verify the required parameter 'authorization' is set
            if (authorization == null)
                throw new ApiException(400, "Missing required parameter 'authorization' when calling AuthenticationApi->ConvertToken");
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("ConvertToken", localVarResponse);
                if (exception != null) throw exception;
            }
        ...
        /// <param name="authorization">The OAuth 2 bearer access token you received from &#x60;/auth/v3/oauth/token&#x60;. For example: \&quot;Authorization: bearer a4b5da75-a584-4053-9227-0f0ab23ff06e\&quot; </param>
        /// <returns>Task of CloudUserDetails</returns>
        public async System.Threading.Tasks.Task<CloudUserDetails> ConvertTokenAsync (string authorization)
        {
             ApiResponse<CloudUserDetails> localVarResponse = await ConvertTokenAsyncWithHttpInfo(authorization);
             return localVarResponse.Data;
        ...
        /// <param name="authorization">The OAuth 2 bearer access token you received from &#x60;/auth/v3/oauth/token&#x60;. For example: \&quot;Authorization: bearer a4b5da75-a584-4053-9227-0f0ab23ff06e\&quot; </param>
        /// <returns>Task of ApiResponse (CloudUserDetails)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<CloudUserDetails>> ConvertTokenAsyncWithHttpInfo (string authorization)
        {
            // verify the required parameter 'authorization' is set
            if (authorization == null)
                throw new ApiException(400, "Missing required parameter 'authorization' when calling AuthenticationApi->ConvertToken");
