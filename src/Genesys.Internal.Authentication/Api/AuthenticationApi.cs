...
namespace Genesys.Internal.Authentication.Api
{
    ...
    public interface IAuthenticationApi : IApiAccessor
    {
        ...
        /// <param name="hideTenant">Hide tenant field in Authorization Code Grant UI (optional, default to false)</param>
        /// <returns></returns>
        void Authorize (string responseType, string redirectUri, string clientId, string authorization = null, string scope = null, bool? hideTenant = null);
        ...
        ApiResponse<Object> AuthorizeWithHttpInfo (string responseType, string redirectUri, string clientId, string authorization = null, string scope = null, bool? hideTenant = null);
        /// <summary>
        /// Change password.
        /// </summary>
        /// <remarks>
        ...
        /// <returns>OpenIdUserInfo</returns>
        OpenIdUserInfo GetInfo (string authorization);
        ...
        /// <exception cref="Genesys.Internal.Authentication.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="authorization">The OAuth 2 bearer access token you received from &#x60;/auth/v3/oauth/token&#x60;. For example: \&quot;Authorization: bearer a4b5da75-a584-4053-9227-0f0ab23ff06e\&quot; </param>
        /// <returns>ApiResponse of OpenIdUserInfo</returns>
        ApiResponse<OpenIdUserInfo> GetInfoWithHttpInfo (string authorization);
        /// <summary>
        ...
        CloudUserDetails GetInfo1 (string authorization);
        ...
        ApiResponse<CloudUserDetails> GetInfo1WithHttpInfo (string authorization);
        /// <summary>
        ...
        System.Threading.Tasks.Task AuthorizeAsync (string responseType, string redirectUri, string clientId, string authorization = null, string scope = null, bool? hideTenant = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<Object>> AuthorizeAsyncWithHttpInfo (string responseType, string redirectUri, string clientId, string authorization = null, string scope = null, bool? hideTenant = null);
        /// <summary>
        /// Change password.
        /// </summary>
        /// <remarks>
        ...
        /// <exception cref="Genesys.Internal.Authentication.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="authorization">The OAuth 2 bearer access token you received from &#x60;/auth/v3/oauth/token&#x60;. For example: \&quot;Authorization: bearer a4b5da75-a584-4053-9227-0f0ab23ff06e\&quot; </param>
        /// <returns>Task of OpenIdUserInfo</returns>
        System.Threading.Tasks.Task<OpenIdUserInfo> GetInfoAsync (string authorization);
        ...
        /// <exception cref="Genesys.Internal.Authentication.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="authorization">The OAuth 2 bearer access token you received from &#x60;/auth/v3/oauth/token&#x60;. For example: \&quot;Authorization: bearer a4b5da75-a584-4053-9227-0f0ab23ff06e\&quot; </param>
        /// <returns>Task of ApiResponse (OpenIdUserInfo)</returns>
        System.Threading.Tasks.Task<ApiResponse<OpenIdUserInfo>> GetInfoAsyncWithHttpInfo (string authorization);
        /// <summary>
        /// Get user information by access token.
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<CloudUserDetails> GetInfo1Async (string authorization);
        ...
        System.Threading.Tasks.Task<ApiResponse<CloudUserDetails>> GetInfo1AsyncWithHttpInfo (string authorization);
        /// <summary>
        /// Retrieve access token.
        /// </summary>
        /// <remarks>
    ...
    public partial class AuthenticationApi : IAuthenticationApi
    {
        ...
        /// <param name="hideTenant">Hide tenant field in Authorization Code Grant UI (optional, default to false)</param>
        /// <returns></returns>
        public void Authorize (string responseType, string redirectUri, string clientId, string authorization = null, string scope = null, bool? hideTenant = null)
        {
        ...
        /// <param name="hideTenant">Hide tenant field in Authorization Code Grant UI (optional, default to false)</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public ApiResponse<Object> AuthorizeWithHttpInfo (string responseType, string redirectUri, string clientId, string authorization = null, string scope = null, bool? hideTenant = null)
        {
            ...
            if (hideTenant != null) localVarQueryParams.AddRange(Configuration.ApiClient.ParameterToKeyValuePairs("", "hideTenant", hideTenant)); // query parameter
        ...
        /// <param name="hideTenant">Hide tenant field in Authorization Code Grant UI (optional, default to false)</param>
        /// <returns>Task of void</returns>
        public async System.Threading.Tasks.Task AuthorizeAsync (string responseType, string redirectUri, string clientId, string authorization = null, string scope = null, bool? hideTenant = null)
        {
             await AuthorizeAsyncWithHttpInfo(responseType, redirectUri, clientId, authorization, scope, hideTenant);
        ...
        /// <param name="hideTenant">Hide tenant field in Authorization Code Grant UI (optional, default to false)</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<ApiResponse<Object>> AuthorizeAsyncWithHttpInfo (string responseType, string redirectUri, string clientId, string authorization = null, string scope = null, bool? hideTenant = null)
        {
            // verify the required parameter 'responseType' is set
            if (responseType == null)
                throw new ApiException(400, "Missing required parameter 'responseType' when calling AuthenticationApi->Authorize");
        ...
        /// <param name="authorization">The OAuth 2 bearer access token you received from &#x60;/auth/v3/oauth/token&#x60;. For example: \&quot;Authorization: bearer a4b5da75-a584-4053-9227-0f0ab23ff06e\&quot; </param>
        /// <returns>OpenIdUserInfo</returns>
        public OpenIdUserInfo GetInfo (string authorization)
        {
             ApiResponse<OpenIdUserInfo> localVarResponse = GetInfoWithHttpInfo(authorization);
             return localVarResponse.Data;
        }
        ...
        public ApiResponse< OpenIdUserInfo > GetInfoWithHttpInfo (string authorization)
        {
            ...
            return new ApiResponse<OpenIdUserInfo>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => x.Value.ToString()),
                (OpenIdUserInfo) Configuration.ApiClient.Deserialize(localVarResponse, typeof(OpenIdUserInfo)));
        }
        ...
        /// <param name="authorization">The OAuth 2 bearer access token you received from &#x60;/auth/v3/oauth/token&#x60;. For example: \&quot;Authorization: bearer a4b5da75-a584-4053-9227-0f0ab23ff06e\&quot; </param>
        /// <returns>Task of OpenIdUserInfo</returns>
        public async System.Threading.Tasks.Task<OpenIdUserInfo> GetInfoAsync (string authorization)
        {
             ApiResponse<OpenIdUserInfo> localVarResponse = await GetInfoAsyncWithHttpInfo(authorization);
             return localVarResponse.Data;
        ...
        /// <param name="authorization">The OAuth 2 bearer access token you received from &#x60;/auth/v3/oauth/token&#x60;. For example: \&quot;Authorization: bearer a4b5da75-a584-4053-9227-0f0ab23ff06e\&quot; </param>
        /// <returns>Task of ApiResponse (OpenIdUserInfo)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<OpenIdUserInfo>> GetInfoAsyncWithHttpInfo (string authorization)
        {
            // verify the required parameter 'authorization' is set
            if (authorization == null)
                throw new ApiException(400, "Missing required parameter 'authorization' when calling AuthenticationApi->GetInfo");
        ...
        /// <param name="authorization">The OAuth 2 bearer access token you received from &#x60;/auth/v3/oauth/token&#x60;. For example: \&quot;Authorization: bearer a4b5da75-a584-4053-9227-0f0ab23ff06e\&quot; </param>
        /// <returns>CloudUserDetails</returns>
        public CloudUserDetails GetInfo1 (string authorization)
        {
             ApiResponse<CloudUserDetails> localVarResponse = GetInfo1WithHttpInfo(authorization);
             return localVarResponse.Data;
        }
        ...
        /// <param name="authorization">The OAuth 2 bearer access token you received from &#x60;/auth/v3/oauth/token&#x60;. For example: \&quot;Authorization: bearer a4b5da75-a584-4053-9227-0f0ab23ff06e\&quot; </param>
        /// <returns>ApiResponse of CloudUserDetails</returns>
        public ApiResponse< CloudUserDetails > GetInfo1WithHttpInfo (string authorization)
        {
            // verify the required parameter 'authorization' is set
            if (authorization == null)
                throw new ApiException(400, "Missing required parameter 'authorization' when calling AuthenticationApi->GetInfo1");
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("GetInfo1", localVarResponse);
                if (exception != null) throw exception;
            }
        ...
        /// <param name="authorization">The OAuth 2 bearer access token you received from &#x60;/auth/v3/oauth/token&#x60;. For example: \&quot;Authorization: bearer a4b5da75-a584-4053-9227-0f0ab23ff06e\&quot; </param>
        /// <returns>Task of CloudUserDetails</returns>
        public async System.Threading.Tasks.Task<CloudUserDetails> GetInfo1Async (string authorization)
        {
             ApiResponse<CloudUserDetails> localVarResponse = await GetInfo1AsyncWithHttpInfo(authorization);
             return localVarResponse.Data;
        ...
        /// <param name="authorization">The OAuth 2 bearer access token you received from &#x60;/auth/v3/oauth/token&#x60;. For example: \&quot;Authorization: bearer a4b5da75-a584-4053-9227-0f0ab23ff06e\&quot; </param>
        /// <returns>Task of ApiResponse (CloudUserDetails)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<CloudUserDetails>> GetInfo1AsyncWithHttpInfo (string authorization)
        {
            // verify the required parameter 'authorization' is set
            if (authorization == null)
                throw new ApiException(400, "Missing required parameter 'authorization' when calling AuthenticationApi->GetInfo1");
