...
namespace Genesys.Internal.Authentication.Model
{
    ...
    public partial class ApiResponse :  IEquatable<ApiResponse>, IValidatableObject
    {
        ...
        public ApiResponse(Object Data = default(Object), ErrorResponse Errors = default(ErrorResponse), string Path = default(string), ResponseStatus Status = default(ResponseStatus))
        {
