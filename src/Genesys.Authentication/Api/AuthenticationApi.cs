...
namespace Genesys.Authentication.Api
{
    ...
    public interface IAuthenticationApi : IApiAccessor
    {
        ...
        /// <param name="authorization">Basic authorization. Example: &#39;Authorization: Basic Y3...MQ&#x3D;&#x3D;&#39; (optional)</param>
        /// <param name="accept">Media types which are acceptable for the response. Example: &#39;Accept: application/x-www-form-urlencoded&#39; (optional)</param>
        /// <param name="scope">Scope (optional)</param>
    ...
    public partial class AuthenticationApi : IAuthenticationApi
    {
        ...
        /// <summary>
        /// Endpoint to retrieve token See &#39;token&#39; endpoint: https://tools.ietf.org/html/rfc6749   Please note that we support only &#39;*&#39; scope. The usage of scope is optional. The set of parameters and their interpretation depend on grant
        /// </summary>
        /// <exception cref="Genesys.Authentication.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="grantType">Grant type</param>
        /// <param name="authorization">Basic authorization. Example: &#39;Authorization: Basic Y3...MQ&#x3D;&#x3D;&#39; (optional)</param>
